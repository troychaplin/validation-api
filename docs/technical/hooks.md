...
Fires after the Block Registry is ready. Use this to interact with the block registry directly (most integrations should use `validation_api_register_block_check()` instead).
